...
public class AeroplaneController : MonoBehaviour {
    ...
    public float Altitude {
        get;    // The aeroplane's height above the ground.
        private set;
    }
    public float Throttle {
        get;    // The amount of throttle being used.
        private set;
    }
    public bool AirBrakes {
        get;    // Whether or not the air brakes are being applied.
        private set;
    }
    public float ForwardSpeed {
        get;    // How fast the aeroplane is traveling in it's forward direction.
        private set;
    }
    public float EnginePower {
        get;    // How much power the engine is being given.
        private set;
    }
    public float MaxEnginePower {
        get {
            return m_MaxEnginePower;    // The maximum output of the engine.
        }
    }
