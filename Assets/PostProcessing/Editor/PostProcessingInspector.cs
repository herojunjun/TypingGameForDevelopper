...
public class PostProcessingInspector : Editor {
    ...
    PostProcessingProfile m_ConcreteTarget {
        get {
            return target as PostProcessingProfile;
        }
    }

    int m_CurrentMonitorID {
        get {
            return m_ConcreteTarget.monitors.currentMonitorID;
        } set {
            m_ConcreteTarget.monitors.currentMonitorID = value;
        }
    }
    ...
    public bool IsInteractivePreviewOpened {
        get;
        private set;
    }
